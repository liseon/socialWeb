...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'AcmeVkBundle' => 'Acme\\VkBundle\\AcmeVkBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'social_market',
            'database_user' => 'social',
            'database_password' => 'f2Qa0G3olsw',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'en',
            'secret' => '4d9466a437627e12cf8e0b18dfade7377e64f06d',
            ...
            'kernel.secret' => '4d9466a437627e12cf8e0b18dfade7377e64f06d',
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array((dirname(dirname(dirname(__DIR__))).'/src/Acme/MainBundle/Resources/config/doctrine') => 'Acme\\MainBundle\\Entity', (dirname(dirname(dirname(__DIR__))).'/src/Acme/VkBundle/Resources/config/doctrine') => 'Acme\\VkBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Acme\\MainBundle\\Entity');
        $b->addDriver($a, 'Acme\\VkBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('AcmeMainBundle' => 'Acme\\MainBundle\\Entity', 'AcmeVkBundle' => 'Acme\\VkBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_af53827224efd53ca9688fd4c72a2b608d5553d097495d857e532fa7ad8ecf54');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler((dirname(dirname(__DIR__)).'/logs/dev.log'), 400, true);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Acme/MainBundle/Resources/views'), 'AcmeMain');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Acme/VkBundle/Resources/views'), 'AcmeVk');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4d9466a437627e12cf8e0b18dfade7377e64f06d');
    }
